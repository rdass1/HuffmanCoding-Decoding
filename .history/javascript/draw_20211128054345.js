function drawGraph(data){
    ...
    var pathR = two.makeCurve(circle.position.x, circle.position.y+circle.radius, curveRX, curveRY,curveRX2,curveRY2, circle2.position.x, circle3.position.y-circle3.radius, true);
    pathR.noFill();
    pathL.linewidth = 3;
