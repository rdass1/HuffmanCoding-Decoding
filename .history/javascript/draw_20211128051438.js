function drawGraph(data){
    ...
    var path = two.makeCurve(circle.position.x, circle.position.y+circle.radius, curveX, curveY,curveX2,curveY2, circle2.position.x, 612, true);
    path.noFill();
    path.linewidth = 3;
    print(path.vertices[3].x);
