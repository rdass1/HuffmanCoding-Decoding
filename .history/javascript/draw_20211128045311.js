function drawGraph(data){
    ...
    var curveX2 = (circle.position.x+circle2.position.x)/2-10;
    var curveY2 = (circle.position.y+circle2.position.y)/2-10;


    var path = two.makeCurve(circle.position.x, circle.position.y+circle.radius, curveX, curveY,curveX2,curveY2, circle2.position.x, circle2.position.y, true);
    path.noFill();
    path.linewidth = 3;
