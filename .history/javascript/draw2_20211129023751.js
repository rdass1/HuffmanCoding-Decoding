...
function makeCircle(root,parent,side){
    if(root===parent){
        ...
        if(root == parent.left){
            ...
            leftSpacingTracker =leftSpacingTracker+ (two.width/leafCounter);
            
            // if(root.id % 2 != 0){
            //     extraOffset = Circle.radius * -3;
            // }
            print(leftSpacingTracker) ;
            var circle = two.makeCircle(leftSpacingTracker ,y1+Circle.offsetY+Circle.radius,Circle.radius);
            ...
            rightSpacingTracker =(two.width/leafCounter)- rightSpacingTracker;
            
            var circle = two.makeCircle(rightSpacingTracker,y1+Circle.offsetY+Circle.radius,Circle.radius);
            circle.fill = Circle.fillColor;
            circle.stroke = Circle.strokeColor;
            circle.linewidth = 5;
            // if(root.id == 2){
