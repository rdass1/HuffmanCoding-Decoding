...
HuffmanCoding.prototype = {
    ...
    printEncodedCode: function(root){
        ...
        document.getElementById("<textarea type="text" readonly style="border: none;"></textarea>").innerHTML += "Code:<br>"+output;
        return output;
    },
    ...
    clearTable: function(){
        document.getElementById("charCodesInOrder").innerHTML = "";
