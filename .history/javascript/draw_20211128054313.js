function drawGraph(data){
    ...
    var pathR = two.makeCurve(circle.position.x, circle.position.y+circle.radius, curveRX, curveRY,curveLX2,curveLY2, circle2.position.x, circle3.position.y-circle3.radius, true);
    pathL.noFill();
    pathL.linewidth = 3;
