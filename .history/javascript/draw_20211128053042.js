function drawGraph(data){
    ...
    var curveRX2 = circle2.position.x+10;
    var curveRY2 = circle2.position.y-30;
    ...
    var pathL = two.makeCurve(circle.position.x, circle.position.y+circle.radius, curveLX, curveLY,curveLX2,curveLY2, circle2.position.x, 100, true);
    pathL.noFill();
    pathL.linewidth = 3;
    ...
    pathR.vertices[2].x += 200;
    pathR.vertices[3].x = circle3.position.x;
