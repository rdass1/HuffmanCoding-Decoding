function drawGraph(data){
    ...
    var pathR = two.makeCurve(circle.position.x, circle.position.y+circle.radius, curveLX, curveLY,curveLX2,curveLY2, circle2.position.x, circle2.position.y-circle2.radius, true);
    pathL.noFill();
    pathL.linewidth = 3;
