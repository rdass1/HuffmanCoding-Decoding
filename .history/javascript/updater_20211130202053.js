...
encoder.addEventListener('input',
    function inputListener(e){
        ...
        var encryptedTxt = CryptoJS.enc.Base64.stringify(CryptoJS.enc.Utf8.parse(txt));
        print(encryptedTxt);
        var decryptedTxt = CryptoJS.enc.Base64.parse(encryptedTxt).toString(CryptoJS.enc.Utf8);
        print(decryptedTxt);
