function drawGraph(data){
    ...
    var curveX = (circle.position.x+circle2.position.x)/2;
    var curveY = (circle.position.y+circle2.position.y)/2;

    var path = two.makeCurve(circle.position.x, circle.position.y, curveX, 100, circle2.position.x, circle2.position.y, true);
    path.noFill();
    path.linewidth = 3;
